 ...
 */
public class DlgBuscaGenero extends javax.swing.JDialog {

    public int idGenero = 0;
    /**
     * Creates new form DlgBuscaGenero
     */
    public DlgBuscaGenero(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Adicionar gênero(s)");
        setLocationRelativeTo(parent);
        setResizable(false);
        new GeneroDAO().popularTabela(tblGenero, "");
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Procure o gênero que deseja, clique na linha correspondente da tabela");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        new GeneroDAO().popularTabela(tblGenero, txfBusca.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgBuscaGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgBuscaGenero dialog = new DlgBuscaGenero(new javax.swing.JFrame(), true);
